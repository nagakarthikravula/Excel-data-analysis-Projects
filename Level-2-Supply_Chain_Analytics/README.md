# Supply Chain & Inventory Analytics — Olist E-Commerce

## 📌 Project Overview
Analyzed 100,000+ e-commerce transactions from Brazilian marketplace Olist to identify delivery performance issues,
regional delays, and seller accountability. The project involved combining 5 separate data tables to build a unified analysis framework.
